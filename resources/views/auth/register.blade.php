...
<head>
    ...
    <title>Inscription - BeatBoxd</title>
...
<body>
    ...
    <main class="auth-page">
        <div class="auth-container">
            <h1 class="auth-title">Inscris-toi dès maintenant !</h1>
            <p class="auth-switch">Déjà un compte ? <a href="{{ route('login') }}">Clique ici !</a></p>
            ...
            <form class="auth-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-input" type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Jean Dupont" required>
                </div>
                <div class="form-group">
